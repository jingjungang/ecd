 ...
 *
 */
public class CustomerDialog_1 extends Dialog {
 
    public CustomerDialog_1(Context context, int theme) {
        super(context, theme);
    }
 
    public CustomerDialog_1(Context context) {
        super(context);
    }
    ...
    public static class Builder {
         ...
         */
        public CustomerDialog_1 create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CustomerDialog_1 dialog = new CustomerDialog_1(context, 
            		R.style.Dialog);
