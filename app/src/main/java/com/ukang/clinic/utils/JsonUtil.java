...
public final class JsonUtil {
	...
	/**
	 * 解析Webservice处理数据是否成功
	 * 
	 * @param
	 */
	public static String getResultFromJson(String josnString) {
		String res = "";
		if (!"".equals(josnString)) {
			String[] result = josnString.split("\\:\\{");
			String[] msg = result[1].split(",");
			res = msg[0].substring(msg[0].length() - 2, msg[0].length() - 1);
		}
		return res;
	}
}
